...
export default {
    name: 'decies',
    props: {
        dices: {type: Array, default: [2, 2]}  // kiểu dữ liệu của dices là aray,  ta gán giá trị mặc định cho xúc xắc là 2-2 
     },
    data() {
        return {
        }
...
/* transform: xây dựng hiệu ứng xoay 3 chiều (trong Css) cho con xúc xắc */
.spinner .face1 { 
